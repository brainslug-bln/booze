<html>
    ...
    <body>
      ...
      <div class="singleColumn versionInfo">
        <h5>Änderungen in Version 2.0</h5>
          <ul>
            <li>
              Die grafische Oberfläche wurde komplett überarbeitet und für die Bedienung mit einem Touchdisplay optimiert.
            </li>
            <li>
              Das Treiberframework wurde von Grund auf neu geschrieben. Treiber können jetzt beliebig viele Optionen erhalten, welche über die grafische Oberfläche eingestellt werden können.
            </li>
            <li>
