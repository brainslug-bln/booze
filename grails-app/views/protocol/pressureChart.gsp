<html>
    ...
    <body>
      <h1><g:message code="protocol.pressureChart.headline" /></h1>
        ...
        <div id="leftColumn_content" class="leftColumn_content">
          <div class="leftNav" id="protocolNav">
            <ul>
              ...
              <li class="active"><a href="${createLink(action:'pressureChart', id:protocolInstance.id)}"><g:message code="protocol.pressureChart.headline" /></a></li>
            </ul>
          </div>
