<html>
    <head>
        <title><g:message code="protocol.pressureChart.headline" /></title>
        <meta name="layout" content="main" />
    </head>
    <body>
      <h1><g:message code="protocol.show.headline" args="${[protocolInstance.recipeName.encodeAsHTML(), formatDate(formatName: 'default.date.formatter', date: protocolInstance.dateStarted)]}"/> - <g:message code="protocol.pressureChart.headline" /></h1>
