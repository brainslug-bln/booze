...
<div class="body">
    ...
    <div id="leftColumn_content" class="leftColumn_content">
      <div class="leftNav" id="protocolNav">
        <ul>
          ...
          <li class="active" onclick="window.location.href='${createLink(action:'editFermentationData', id:protocolInstance.id)}'"><a href="${createLink(action:'editFermentationData', id:protocolInstance.id)}"><g:message code="protocol.editFermentationData" /></a></li>
  ...
  <div class="rightColumn">
    <div class="rightColumn_content">
      ...
      <g:render template="fermentation" model="${[protocolInstance: protocolInstance]}"/>
