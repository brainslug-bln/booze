 ...
 * $Id: T6963C.java,v 1.1 2006/02/22 20:55:34 Thomas Wagner Exp $
 ...
 * @since 0.9.5
 */
public class LCD16x21Pio extends AbstractLCD {
    ...
    public LCD16x21Pio(AbstractIowDevice dev) {
        lcd = new T6963CPio(dev, T6963CPio.MODE_TEXT_ON, T6963CPio.FONT_6X8);
    }
